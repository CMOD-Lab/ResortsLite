...
public class BookingService {
    ...
    // variable PAYMENT_API_URL injected via AKS ConfigMap / Azure Key Vault CSI Driver.
    ...
    // to a dedicated report path resolved via environment variable, reducing tight coupling
    // between booking and reporting concerns for independent AKS microservice deployment.
