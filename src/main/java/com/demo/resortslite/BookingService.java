 ...
 * Database credentials are retrieved from AWS Secrets Manager (blocker-8, blocker-9: cr-java-0069).
 * File-based authentication replaced with AWS Secrets Manager (blocker-18: cr-java-0090).
 */
@Service
public class BookingService {
    ...
    // blocker-8, blocker-9: cr-java-0069 — Hard-coded DB credentials replaced with
    // AWS Secrets Manager. Credentials are retrieved at runtime, never stored in source code.
    ...
    // Auth credentials are retrieved from Secrets Manager, not from local files.
     ...
     * Replaces hard-coded DB_HOST, DB_USER, DB_PASS constants (blocker-8, blocker-9: cr-java-0069).
     *
     ...
     * @return a status message for the report generation
     */
