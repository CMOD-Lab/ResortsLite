...
public class BookingController {
    ...
    // Blocker-10 (cr-java-0071): Hard-coded inventory URL replaced with value loaded from
    // Azure App Configuration via the app.inventory.endpoint property, enabling
    ...
    public Map<String, Object> checkAvailability(@RequestParam String roomType) {
        // Blocker-10 (cr-java-0071): inventoryEndpoint is now injected from Azure App Configuration
        // via the app.inventory.endpoint property — no hard-coded URL in source code.
        Map<String, Object> response = new HashMap<>();
