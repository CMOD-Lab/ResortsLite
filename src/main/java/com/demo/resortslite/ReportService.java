...
public class ReportService {
    ...
    // blocker-2: Replaced hardcoded absolute path "/var/legacy/reports/" with
    ...
    // with environment variable BACKUP_PATH injected via Kubernetes ConfigMap on EKS.
    @Value("${BACKUP_PATH:/backups/nightly}")
    private String backupPath;

    // blocker-11: Replaced hardcoded port 8080 with environment variable SERVER_PORT
    // injected via Kubernetes ConfigMap, enabling flexible port assignment per environment.
